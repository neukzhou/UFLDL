...
%    for row = 1:imageDim - patchDim + 1
%        for col = 1:imageDim - patchDim + 1
%            patch = trainImages(row:row+7, col:col+7, 1:3, imageNum);
%            x = patch(:);
%            patchFeature = sigmoid(W * x + b);
%            features(:, imageNum, row, col) = patchFeature;
%        end
%    end
%end
